...
To = ''
PASSWORD = ''
SUB = 'wear更新通知（ショーパン+166~170cm+更新順）'
URL = "http://wear.jp/sp/women-coordinate/?search_word=%E3%82%B7%E3%83%A7%E3%83%BC%E3%83%91%E3%83%B3&from_height=166&to_height=170&type_id=2"
...
def wear_update_check(str_class_time):
    ...
    if '分前' in str_class_time:
      ...
      if int_class_time <= 10: #10時間以内に更新があったかどうか。あったら通知用に本文をセット。
          message = (str_class_time + 'に更新がありました。ちぇけらψ(｀∇´)ψ¥n¥n' + URL)
          return message
      else:
          pass
